...
public class DisrupterRobot extends BaseRobot {
	...
	public void run() throws GameActionException {
		...
		if(gotHitLastRound && (closestEnemyLocation==null || 
			...
			checkedBehind = false;
				...
				(closestEnemyLocation == null || curLoc.distanceSquaredTo(closestEnemyLocation) > 10)) { 
	...
	public MoveInfo computeNextMove() throws GameActionException {
		...
		if(behavior == BehaviorState.LOOK_AROUND_FOR_ENEMIES) {
			...
			if(distToTarget <= 16 && (curDir.ordinal()-dirToTarget.ordinal()+9)%8 > 2) {
	...
	//Logical distancing method
	//TODO: Ask the question, "Should I even bother...?"
